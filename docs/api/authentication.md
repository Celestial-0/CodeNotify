...
See [Auth Module](/backend/modules/auth) for authentication implementation details.
...
- [Guards](/backend/security/guards) - Route protection
- [Auth Module](/backend/modules/auth) - Complete implementation
