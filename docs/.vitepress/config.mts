    ...
    nav: [
      ...
      { 
        ...
        items: [
          ...
          { text: 'Modules', link: '/backend/modules' },
          { text: 'Platform Adapters', link: '/backend/adapters' },
      ...
      '/backend/': [
        {
          ...
          collapsed: false,
          items: [
            { text: 'System Overview', link: '/backend/architecture' },
            { text: 'Module Structure', link: '/backend/modules' },
            { text: 'Design Patterns', link: '/backend/patterns' },
            { text: 'Platform Adapters', link: '/backend/adapters' },
            { text: 'Database Design', link: '/backend/database' },
            { text: 'Scheduler & Jobs', link: '/backend/scheduler' }
          ]
        },
        {
          text: 'Core Modules',
          collapsed: false,
          items: [
            { text: 'Auth Module', link: '/backend/modules/auth' },
            { text: 'Users Module', link: '/backend/modules/users' },
            { text: 'Contests Module', link: '/backend/modules/contests' },
            { text: 'Notifications Module', link: '/backend/modules/notifications' },
            { text: 'Integrations Module', link: '/backend/modules/integrations' }
          ]
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Adapter Pattern', link: '/backend/adapters' },
            { text: 'Base Adapter', link: '/backend/adapters/base' },
            { text: 'Codeforces', link: '/backend/adapters/codeforces' },
            { text: 'LeetCode', link: '/backend/adapters/leetcode' },
            { text: 'CodeChef', link: '/backend/adapters/codechef' },
            { text: 'AtCoder', link: '/backend/adapters/atcoder' }
          ]
        },
        {
          text: 'Database',
          ...
          items: [
            ...
            { text: 'User Schema', link: '/backend/database/user' },
            { text: 'Contest Schema', link: '/backend/database/contest' },
            { text: 'Notification Schema', link: '/backend/database/notification' },
            { text: 'Indexes & Performance', link: '/backend/database/indexes' }
          ]
        },
        {
          text: 'Security',
          collapsed: true,
          items: [
            { text: 'JWT Authentication', link: '/backend/security/jwt' },
            { text: 'Password Hashing', link: '/backend/security/bcrypt' },
            { text: 'Guards & Strategies', link: '/backend/security/guards' }
          ]
        },
        {
          text: 'Deployment',
          collapsed: true,
          items: [
            { text: 'Deployment Guide', link: '/backend/deployment' },
            { text: 'Docker Setup', link: '/backend/deployment/docker' }
          ]
        },
        {
          text: 'Resources',
