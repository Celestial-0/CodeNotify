...
- [User Schema](/backend/database/user)
- [Contest Schema](/backend/database/contest)
- [Notification Schema](/backend/modules/notifications#notification-schema)
- [Database Design](/backend/database) - Overall database architecture
