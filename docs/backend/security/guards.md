...
- [JWT Authentication](/backend/security/jwt) - Token generation and validation
- [Auth Module](/backend/modules/auth) - Complete authentication system
- [Sign In](/api/auth/signin) - Get access token
- [Security](/backend/security/jwt) - Security implementation
