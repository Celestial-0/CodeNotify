...
- [Codeforces Adapter](/backend/adapters/codeforces) - REST API example
- [LeetCode Adapter](/backend/adapters/leetcode) - GraphQL example
- [CodeChef Adapter](/backend/adapters/codechef) - Multi-category API
- [AtCoder Adapter](/backend/adapters/atcoder) - Community API
- [Contests Module](/backend/modules/contests) - Contest management
