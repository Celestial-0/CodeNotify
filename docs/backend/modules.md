...
CodeNotify backend follows NestJS modular architecture with clear separation of concerns and dependency injection.
...
- [Auth Module](/backend/modules/auth) - Authentication details
- [Users Module](/backend/modules/users) - User management
- [Contests Module](/backend/modules/contests) - Contest operations
- [Notifications Module](/backend/modules/notifications) - Notification system
- [Platform Adapters](/backend/adapters) - Platform integration patterns
