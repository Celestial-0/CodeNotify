...
**Schema**: [User Schema](/backend/database/user)
...
**Schema**: [Contest Schema](/backend/database/contest)
...
**Schema**: [Notification Schema](/backend/database/notification)
...
- [User Schema](/backend/database/user) - Detailed user schema
- [Contest Schema](/backend/database/contest) - Detailed contest schema
- [Notification Schema](/backend/database/notification) - Detailed notification schema
- [Indexes](/backend/database/indexes) - Index optimization
- [System Architecture](/backend/architecture) - Backend architecture
