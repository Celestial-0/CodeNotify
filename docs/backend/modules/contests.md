...
**File**: `backend/src/contests/schemas/contest.schema.ts`
...
**File**: `backend/src/contests/dto/contest.dto.ts`
...
- [Platform Adapters](/backend/adapters) - Integration details
- [Scheduler](/backend/scheduler) - Sync scheduling
- [Database](/backend/database) - Schema details
