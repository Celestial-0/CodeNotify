...
**Documentation:** See [Platform Adapters](/backend/adapters) for detailed documentation.

### 2. WhatsappService

Stub service for future WhatsApp Business API integration.

**Location:** `backend/src/integrations/whatsapp/whatsapp.service.ts`
...
**Documentation:** [Codeforces Adapter](/backend/adapters/codeforces)
...
**Documentation:** [LeetCode Adapter](/backend/adapters/leetcode)
...
**Documentation:** [CodeChef Adapter](/backend/adapters/codechef)
...
**Documentation:** [AtCoder Adapter](/backend/adapters/atcoder)
...
- [Platform Adapters Overview](/backend/adapters)
- [Base Adapter](/backend/adapters/base)
- [Codeforces Adapter](/backend/adapters/codeforces)
- [LeetCode Adapter](/backend/adapters/leetcode)
- [CodeChef Adapter](/backend/adapters/codechef)
- [AtCoder Adapter](/backend/adapters/atcoder)
- [Contests Module](/backend/modules/contests)
