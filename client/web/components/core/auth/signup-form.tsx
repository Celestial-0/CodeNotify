...
import { Eye, EyeOff, Loader2, ChevronLeft, Code2, AtSign, User, Phone } from "lucide-react";
import { toast } from "sonner";
import { AxiosError } from "axios";
import { motion } from "framer-motion";

import { SignupSchema, type SignupFormData } from "@/lib/types/auth.types";
      ...
      <div className="bg-muted/60 relative hidden h-full flex-col border-r p-10 lg:flex">
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-xl">
              &ldquo;Joining CodeNotify was the best decision for my competitive
              programming journey. Real-time notifications help me stay ahead.&rdquo;
            </p>
        ...
        <div className="mx-auto space-y-4 sm:w-sm">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <p className="text-muted-foreground text-base">
              Join CodeNotify to never miss a contest
            </p>
          </div>
