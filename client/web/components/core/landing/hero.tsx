...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-background selection:bg-primary/20">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-4 pt-20 pb-32 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 max-w-4xl text-center">
          <h1 className={`text-4xl font-bold tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl transition-all duration-1000 delay-100 ${mounted ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
        ...
        {/* 3. CTA Buttons */}
        <div className={`mt-10 flex flex-col gap-4 sm:flex-row transition-all duration-1000 delay-300 ${mounted ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
        ...
        <div className={`mt-16 flex w-full max-w-2xl flex-wrap justify-center gap-4 transition-all duration-1000 delay-700 ${mounted ? "opacity-100" : "opacity-0"}`}>
